...
The 0 and the 4 denotes two anonymous instructions (we care more about loads,
...
In this example, we only have two new things to cover. The ”m” denotes a memory dependency, some data that
